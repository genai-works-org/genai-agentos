...
# Configuration
DEFAULT_VOICE_ID = os.getenv("ELEVEN_LABS_VOICE_ID", "21m00Tcm4TlvDq8ikWAM")  # Rachel voice
...
def list_audio_files() -> str:
    """
    List all available audio files with their download URLs.
    
    Returns:
        JSON string of available audio files with URLs
    """
    try:
        audio_files = []
