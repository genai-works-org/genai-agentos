...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_a2a_card_server_url', 'a2acards', ['creator_id', 'server_url'])
    op.drop_constraint('mcpservers_server_url_key', 'mcpservers', type_='unique')
    op.create_unique_constraint('uq_mcp_server_url', 'mcpservers', ['creator_id', 'server_url'])
...
def downgrade() -> None:
    ...
    op.create_unique_constraint('mcpservers_server_url_key', 'mcpservers', ['server_url'])
